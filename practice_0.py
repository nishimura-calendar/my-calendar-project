...
def normalize_text(text):
    ...
    # 比較のために空白を除去し、英数を半角・小文字に統一
    return re.sub(r'[\s　]', '', text).lower()

def extract_year_month_from_text(text):
    """ファイル名(正)から年・月・日数・第1曜日を取得"""
